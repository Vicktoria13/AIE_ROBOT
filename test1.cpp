...
int main()
{
	...
	projectiles.push_back(CircleShape(projectile)); //constructeur par copie
	...
	while (window.isOpen())
	{
		...
		if (sf::Keyboard::isKeyPressed(sf::Keyboard::Space) && shootTimer >= 10) //Shoot
		{
...
//collision 
//entres les projectiles et mur : une boucle 15x15
//entre les projectiles et l'ennemi : 
